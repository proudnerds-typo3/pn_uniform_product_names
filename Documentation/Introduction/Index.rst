...
This extension is aimed at Dutch government organizations. It implements extra page properties to set Uniform Product Names and produces a XML feed for the Samenwerkende Catalogi (SC). Also provided is a scheduler task to periodically import the official product names.
